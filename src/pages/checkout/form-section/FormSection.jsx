                ...
                <div className="col-sm-8">
                    ...
                    <div className="group-select justify" tabIndex={1}>
                        ...
                        <ul className="dropdown">
                            ...
                            <li data-value="Brunei Darussalam">
                                Brunei Darussalam
                            </li>
                            ...
                            <li data-value="Christmas Island">
                                Christmas Island
                            </li>
                            <li data-value="Cocos (Keeling) Islands">
                            ...
                            <li data-value="France, Metropolitan">
                                France, Metropolitan
                            </li>
                            <li data-value="French Guiana">French Guiana</li>
                            <li data-value="French Polynesia">
                                French Polynesia
                            </li>
                            ...
                            <li data-value="Korea, Republic of">
                                Korea, Republic of
                            </li>
                            <li data-value="Kosovo, Republic of">
                                Kosovo, Republic of
                            </li>
                            ...
                            <li data-value="Libyan Arab Jamahiriya">
                            ...
                            <li data-value="Moldova, Republic of">
                                Moldova, Republic of
                            </li>
                            ...
                            <li data-value="Netherlands Antilles">
                            ...
                            <li data-value="Northern Mariana Islands">
                            ...
                            <li data-value="Russian Federation">
                                Russian Federation
                            </li>
                            ...
                            <li data-value="St. Martin (French part)">
                                St. Martin (French part)
                            </li>
                            <li data-value="St. Pierre and Miquelon">
                            ...
                            <li data-value="Syrian Arab Republic">
                            ...
                            <li data-value="Virgin Islands (British)">
                                Virgin Islands (British)
                            </li>
                            <li data-value="Virgin Islands (U.S.)">
                                Virgin Islands (U.S.)
                            </li>
            ...
            <div className="row group">
                ...
                <div className="col-sm-8">
                    <div className="group-select justify" tabIndex={1}>
                        ...
                        />
                        <ul className="dropdown">
                            <li data-value="Cash on Delivery">
                                Cash on Delivery
                            </li>
